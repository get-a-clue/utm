...
typedef  std::list<std::unique_ptr<utm::ubase>> trafficreport_daytick_container;
...
public:
    ...
    virtual const char *get_this_class_name() const { return "trafficreport_filter_base"; };
